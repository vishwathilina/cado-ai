...
const steps = [
  { icon: CloudUploadIcon, title: "1. Upload", copy: "Drop a PDF or a photo of your notes." },
  ...
  return (
    <main className="stars min-h-screen overflow-hidden">
      ...
      <section className="relative mx-auto grid max-w-6xl items-center gap-10 px-6 pb-16 pt-8 md:grid-cols-[1.1fr_.9fr] md:pt-12">
        <div>
          <p className="mb-5 w-fit rounded-full border-2 bg-[var(--surface)] px-4 py-2 text-sm font-extrabold text-[var(--primary)]">
