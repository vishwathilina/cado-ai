...
const features: Feature[] = [
  {
    title: "Track quiz accuracy",
    description: "See scores, missed topics, and retry links in one view — like a spreadsheet for what you still need to learn.",
    preview: SpreadsheetPreview,
  },
  {
    title: "Your study dashboard",
    description: "A daily snapshot of streaks, weak topics, countdowns, and what to review next.",
    preview: EngineeringPreview,
  },
  {
    title: "Flashcards from your notes",
    description: "Cado pulls key terms and concepts into flip cards you can run through before the quiz.",
    preview: ResumeLines,
  },
  {
    title: "Mind maps by section",
    description: "Visual section maps help you see how topics connect before you dive into explanations.",
    preview: PixelArtPreview,
  },
  {
    title: "Weak-topic digest",
    description: "Cado surfaces what you missed on quizzes so you know exactly what to retry.",
    preview: InboxPreview,
  },
  {
    title: "Seven-day study plan",
    description: "Each week, a quiet schedule of tasks, timers, and progress so you always know what’s next.",
